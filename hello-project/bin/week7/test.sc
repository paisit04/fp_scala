...
object test {
  val problem = new Pouring(Vector(4,9, 19))      //> problem  : week7.Pouring = week7.Pouring@52c05d3b
  problem.moves                                   //> res0: scala.collection.immutable.IndexedSeq[Product with Serializable with we
                                                  ...
                                                  //| 
  problem.solutions(17)                           //> res1: Stream[week7.test.problem.Path] = Stream(Fill(1) Pour(1,2) Fill(0) Pou
