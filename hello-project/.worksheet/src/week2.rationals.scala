...
object rationals {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(62); 
  ...
  x + y;System.out.println("""res2: week2.Rational = """ + $show(res$2));$skip(31); 
  ...
  y + y;System.out.println("""res4: week2.Rational = """ + $show(res$4));$skip(11); val res$5 = 
  ...
  x max y;System.out.println("""res7: week2.Rational = """ + $show(res$7));$skip(21); val res$8 = 
